...
> Инструкция для кодового ассистента по выполнению работ согласно [техническому видению](vision.md) и [итерациям проекта](ITERATIONS.md)
...
- Работа только по согласованным итерациям из [ITERATIONS.md](ITERATIONS.md)
...
- [ ] Определить следующую незавершенную итерацию в [ITERATIONS.md](ITERATIONS.md)
...
- [ ] Отметить выполненные задачи в [ITERATIONS.md](ITERATIONS.md)
- [ ] Обновить статус итерации в [ITERATIONS.md](ITERATIONS.md)
- [ ] Добавить дату завершения в [ITERATIONS.md](ITERATIONS.md)
...
**Следующая итерация:** Найти в [ITERATIONS.md](ITERATIONS.md) первую незавершенную итерацию (статус 🔲)
